...
type SystemService interface {
	CreateWorkspace(logo []byte, ownerId primitive.ObjectID, workspaceId, name string) error
	...
	GetAllUsers(userId primitive.ObjectID, workspaceId, teamId string) ([]model.UserResponse, error)
}
